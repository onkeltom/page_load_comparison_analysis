...
ggplot(by_browser, aes(Browser, means)) +
  geom_bar(stat = "identity", width = 0.5) +
  scale_fill_manual(values=cbPalette) +
  theme_classic() +
  labs(y = "Average page load time per browser in ms")
...
```{r bs_browser}
ggplot(bootstrap, aes(means, fill=Browser)) +
  geom_histogram(position="identity", alpha = 0.7, binwidth = 100) + 
  scale_fill_manual(values=cbPalette) +
  theme_classic() +
  labs(y = "Number of occurrence", x = "Average page load time", fill = "Browser")
```
...
qplot(distance, geom = "histogram", binwidth = 0.05) +
  theme_classic() +
  labs(y = "Number of occurrence", x = "Difference in average page load time between Chrome and Firefox Quantum")
```
